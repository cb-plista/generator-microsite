...
Generator.prototype.welcome = function welcome() {
    ...
    if (!this.options['skip-welcome-message']) {
        console.log('---------------------------------------------------');
        console.log('--- plista microsite');
        console.log('--- author: ch@plista.com');
        console.log('--- if u have any kind of question don\'t hesitate');
        console.log('---------------------------------------------------');
...
Generator.prototype.askFromData = function askFromData(){
    var cb = this.async();

    this.prompt([
        {
            name: 'advertiserName',
            message: 'what is the advertiser name called?',
            default: ''
        },
        {
            name: 'advertiserId',
            message: 'what is the advertiser Id?',
            default: 0
        },
        {
            name: 'campaignName',
            message: 'what is the campaign name called?',
            default: ''
        },
        {
            name: 'campaignId',
        ...
        this.advertiserName = props.advertiserName;
        this.advertiserId = parseInt(props.advertiserId,10);
        this.campaignName = props.campaignName;
        this.campaignId = parseInt(props.campaignId);
